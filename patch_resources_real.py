...
if old_endpoint not in src:
    raise SystemExit("ERROR: resources endpoint not found -- printing file:\n" + src)
...
if src == original:
    ...
    print("main.py patched -- /resources/{county} now returns real infrastructure records as a plain array.")
